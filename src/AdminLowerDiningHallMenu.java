...
public class AdminLowerDiningHallMenu extends JFrame{
	private JPanel panel = new JPanel(new GridBagLayout());
	
	private JLabel ucc = new JLabel("Upper Canada College");
	private JButton adminHome = new JButton("Administration Home");
	...
	private LowerDiningHallMenu[] menus;
	...
	private ActionListener alisten = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == editdays[0]) {
				...
				LDHEditMenu tempLDH = new LDHEditMenu(temparr[0],temparr[1],temparr[2],temparr[3],menus[currentMenu],meals[0]);
			}
			if (e.getSource() == editdays[1]) {
				...
				LDHEditMenu tempUDH= new LDHEditMenu(temparr[0],temparr[1],temparr[2],temparr[3],menus[currentMenu + 1],meals[1]);
			...
			if (e.getSource() == editdays[2]) {
				...
				LDHEditMenu tempUDH= new LDHEditMenu(temparr[0],temparr[1],temparr[2],temparr[3],menus[currentMenu + 2],meals[2]);
			...
			if (e.getSource() == editdays[3]) {
				...
				LDHEditMenu tempUDH= new LDHEditMenu(temparr[0],temparr[1],temparr[2],temparr[3],menus[currentMenu + 3],meals[3]);
			...
			if (e.getSource() == editdays[4]) {
				...
				LDHEditMenu tempUDH= new LDHEditMenu(temparr[0],temparr[1],temparr[2],temparr[3],menus[currentMenu + 4],meals[4]);
	...
	public AdminLowerDiningHallMenu(Controller x1) {
		x = x1;
		...
		this.add(panel);
		//this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //This kills everything. 
		this.pack();
	...
	//public static void main(String[] args) {
		// TODO Auto-generated method stub
		//AdminLowerDiningHallMenu a = new AdminLowerDiningHallMenu();
	//}
